...
public class Activity3 {
    ...
    public void addNotesKeepTest(){
        ...
        wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.xpath("//android.widget.Button[@content-desc='Reminder']"))).click();
        wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.id("com.google.android.keep:id/menu_text"))).click();

        wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.id("com.google.android.keep:id/reminder_chip"))).click();
        wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.id("com.google.android.keep:id/time_spinner"))).click();
        wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.xpath("//android.widget.TextView[@resource-id='com.google.android.keep:id/text' and @text='Afternoon']"))).click();
        wait.until(ExpectedConditions.elementToBeClickable(AppiumBy.id("com.google.android.keep:id/save"))).click();
        ...
        String reminderText = driver.findElement(AppiumBy.id("com.google.android.keep:id/reminder_chip_text")).getText();
